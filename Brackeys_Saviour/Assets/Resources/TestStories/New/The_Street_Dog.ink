...
* [Pet the dog] # Happiness: +1 -> Pet
* [Ignore the dog and keep walking] -> KeepWalking
...
* [Take the dog to a vet to see if he's microchipped] # Money: -50 -> Vet
* [Take the dog home with you] # Happiness: +2 # Volunteer: +1 -> TakeHome
* [Leave the dog and continue on your walk] -> KeepWalking
...
* [Take the dog to a shelter] # Volunteer: +2 -> Shelter
* [Decide to keep the dog yourself] # Happiness: +3 # Volunteer: +1 -> KeepDog
...
* [Go back and take the dog to a shelter] # Volunteer: +1 -> Shelter
* [Continue on your walk] -> DONE
